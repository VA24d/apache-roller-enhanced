...
/**
 * Command abstraction to encapsulate bug mutation operations.
 */
public interface BugReportCommand {

    BugReport execute(BugReportManager manager) throws WebloggerException;
}
